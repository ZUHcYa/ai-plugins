...
**Plugins:** music-production (Music Production Lifecycle), knvs (Business Model Innovation), research (Structured Research Pipeline)
**State-Dirs:** `.music-production/`, `.knvs/`, `.research/` (alle gitignored)
