...
**Plugins:** music-production (Music Production Lifecycle), knvs (Business Model Innovation), trips (Dienstreisen-Tracking), research (Structured Research Pipeline), journal (Personal Journal)
**State-Dirs:** `.music-production/`, `.knvs/`, `.trips/`, `.research/`, `.journal/` (alle gitignored)
