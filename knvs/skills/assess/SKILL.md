...
| 4 | **Social/Cultural Trends** | Social and cultural trends that are projected to grow are driving customers away from us (e.g., sustainability, fashion, etc.). | Various trends are making it harder for our customers to desert us and the friction for them to leave is increasing. |
